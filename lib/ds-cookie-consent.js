...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    var oldCookieNotice = document.querySelector(Data.oldCookieBannerWrapper["class"]); // Delete GA cookies

    dsCookieConsentBannerAPI.deleteCookie(Data.cookiesToRemove.one, Data.cookiesToRemove.two, Data.cookiesToRemove.three); // Hide the old yellow Cookie banner for the MVP
