...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    var oldCookieNotice = document.querySelector(Data.oldCookieBannerWrapper["class"]);
    dsCookieConsentBannerAPI.setCookie("_gaa", "true", {
      "max-age": 3600,
      domain: ".nationalarchives.gov.uk"
    }); //Delete GA cookies

    dsCookieConsentBannerAPI.deleteCookie("_gaa", Data.cookiesToRemove.one, Data.cookiesToRemove.two, Data.cookiesToRemove.three); // Hide the old yellow Cookie banner for the MVP
