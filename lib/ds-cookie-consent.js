...
(function () {
  var getBannerElement = document.querySelector("#ds-cookie-consent-banner"); // Check if cookie banner exists
  ...
  if (getBannerElement) {
    ...
    var bannerParagraph = document.querySelector(".cookie-p"); // Check if the button Accept Optional Cookies exists
    ...
    if (btnAccept) {
      ...
      btnAccept.addEventListener("click", function (e) {
        ...
        if (bannerParagraph) {
          bannerParagraph.innerHTML = "You have accepted additional cookies. You can <a href='#'>change your cookie settings</a> at any time.";
