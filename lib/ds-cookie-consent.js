...
var Data = {
  ...
  acceptMessageAfterInteraction: {
    text: "You can change your cookie settings on the <a href='/latin/legal/cookies/'>Cookies</a> page.",
    ariaLabel: "Cookie consent confirmation message"
  },
  rejectMessageAfterInteraction: {
    text: "You have rejected optional cookies. You can change your cookie settings on the <a href='/latin/legal/cookies/'>Cookies</a> page.",
    ariaLabel: "Cookie consent confirmation message"
  },
...
var dsCookieConsentBannerAPI = function () {
  ...
  var createLink = function createLink(text, url, id, className, tabindex) {
  ...
  var createButton = function createButton(text, id, className, tabindex) {
    var getInnerElem = document.querySelector(Data.buttonPreferences.id);
    var createButtonLink = document.createElement("button");
    var linkText = document.createTextNode(text);
...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (getBannerElement) {
      ...
      dsCookieConsentBannerAPI.createButton(Data.buttonAccept.text, Data.buttonAccept.id, Data.buttonAccept["class"], Data.buttonAccept.tabIndex); // Create Reject Optional Cookies

      dsCookieConsentBannerAPI.createButton(Data.buttonReject.text, Data.buttonReject.id, Data.buttonReject["class"], Data.buttonReject.tabIndex); // Select the buttons
      ...
      var cookieHead = document.querySelector(Data.bannerHeadline.id);
      ...
      if (btnAccept) {
        ...
        btnAccept.addEventListener("click", function (e) {
          ...
          dsCookieConsentBannerAPI.createLink(Data.hideThisMessage.text, Data.hideThisMessage.url, Data.hideThisMessage.id, Data.hideThisMessage["class"], Data.hideThisMessage.tabIndex);
          ...
          if (bannerParagraph) {
            ...
            getBannerElementContainer.setAttribute("aria-label", Data.acceptMessageAfterInteraction.ariaLabel);
          } // Get the Hide This Message DOM element


          var hideThisMessage = document.querySelector("#".concat(Data.hideThisMessage.id)); // If Hide This Message DOM exists, hide banner
      ...
      if (btnReject) {
        ...
        btnReject.addEventListener("click", function (e) {
          ...
          if (bannerParagraph) {
            ...
            getBannerElementContainer.setAttribute("aria-label", Data.rejectMessageAfterInteraction.ariaLabel);
          } // Get the Hide This Message DOM element
