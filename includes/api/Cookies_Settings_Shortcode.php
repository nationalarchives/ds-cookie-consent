...
function shortcode_settings_page( $atts ) {
    ...
    $output .= '<p class="reduced-margin">' . get_option('our_first_field') . '</p>';
    ...
    $output .= (isset($atts['settings']) && $atts['settings'] == 'show') ? '<p class="reduced-margin">' . get_option('our_second_field') . '</p>' : '';
    ...
    $output .= '<p class="reduced-margin">' . get_option('our_third_field') . '</p>';
